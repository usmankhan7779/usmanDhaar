...
export class BuyerDashboardServices {
  ...
  InsertWomenMaxBid(proID: any, MaxPrice: any) {
    return this._http.post(this.ServerUrl + 'WomenFashionProductMaxBid', {
      'ProductID': proID,
      'MaxBidPrice': MaxPrice,
    })
      .map((res: Response) => {
  ...
  InsertMenMaxBid(proID: any, MaxPrice: any) {
    return this._http.post(this.ServerUrl + 'MenFashionProductMaxBid', {
      'ProductID': proID,
      'MaxBidPrice': MaxPrice,
    })
      .map((res: Response) => {
  ...
  InsertTVMaxBid(proID: any, MaxPrice: any) {
    return this._http.post(this.ServerUrl + 'TVAudioVideoProductMaxBid', {
      'ProductID': proID,
      'MaxBidPrice': MaxPrice,
    })
      .map((res: Response) => {
  ...
  InsertHomeMaxBid(proID: any, MaxPrice: any) {
    return this._http.post(this.ServerUrl + 'HomeAppliancesProductMaxBid', {
      'ProductID': proID,
      'MaxBidPrice': MaxPrice,
    })
      .map((res: Response) => {
